...
import { getAiFrequencyUsingGET } from '@/services/MedAI/aiFrequencyController';
import { addOrderUsingPOST } from '@/services/MedAI/aiFrequencyOrderController';
import {
  getLoginUserUsingGET,
  getUserVOByIdUsingGET,
  updateByProfileUserUsingPOST,
  updateMyInfoUsingPOST,
} from '@/services/MedAI/UserController';
...
const UserInfo: React.FC = () => {
  ...
  return (
    <>
      ...
      <Divider style={{ fontWeight: 'bold', color: 'blue' }}>AI数据分析次数</Divider>
