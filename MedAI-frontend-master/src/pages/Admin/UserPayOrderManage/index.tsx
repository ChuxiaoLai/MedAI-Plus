import {listMyOrderByPageUsingPOST, listOrderByPageUsingPOST} from '@/services/MedAI/aiFrequencyOrderController';
import { payCodeUsingPOST, tradeQueryUsingPOST } from '@/services/MedAI/aliPayController';
