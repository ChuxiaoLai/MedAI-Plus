...
} from '@/services/MedAI/ChartController';
...
import {aiAssistantUsingPOST} from "@/services/MedAI/AiAssistantController";
    ...
    <div className="add-chat">
      <Card>
        ...
        >
          ...
          >
            <TextArea placeholder="请输入问题名称，比如：怎么使用折线图？"/>
          </Form.Item>
          <Form.Item
            name="questionGoal"
            label="你的问题"
          ...
          >
            <TextArea placeholder="请输入你的分析需求，比如：我要怎么样更好地使用折线图进行分析？"/>
          </Form.Item>
          ...
          >
            <TextArea placeholder="请输入你的问题类型，比如：图表学习"/>
          </Form.Item>
