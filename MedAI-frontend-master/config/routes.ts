...
export default [
  ...
  { path: '/add_chart', name: 'AI数据分析(同步)', icon: 'icon-tubiao1', component: './AddChart' },  // <LineChartOutlined />
  { path: '/add_chart_async', name: 'AI数据分析(异步)', icon: 'icon-tubiao1', component: './AsyncAddChart' },
  ...
  { path: '/viewChartData/:id', icon: 'checkCircle', component: './ViewChartData', name: '查看图表', hideInMenu: true,  },
  {
    ...
    routes: [
      { path: '/ai_question/assistant', name: 'AI 问答', icon: 'smile', component: './AiChatAssistant/AddChat' },
